...
# Lab 05
# Lab Section: 16
# Sources, people worked with, help given to: Lab 04
# Using what was done before to make this new code.
...
current_max = max_temps[0]

for max_temp in max_temps:
    if max_temp > current_max:
        current_max = max_temp

print(f"Max temp = {current_max}")

current_min = min_temps[0]

for min_temp in min_temps:
    if min_temp < current_min:
        current_min = min_temp
print(f"Min temp = {current_min}")
